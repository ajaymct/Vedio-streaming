...
class PerformerlistController extends MainAdminController
{
    ...
    public function performer_list()    { 
        ...
        // {
            ...
            $performer_list = Performers::orderBy('id','DESC')->paginate(10);

       // }
         
        return view('admin.pages.performer_list',compact('page_title','performer_list','language_list'));
    }
    ...
    public function delete($series_id)
    {
    	if(Auth::User()->usertype=="Admin" OR Auth::User()->usertype=="Sub_Admin")
        {
            ...
            $series_obj = Performers::findOrFail($series_id);
            $series_obj->delete();
