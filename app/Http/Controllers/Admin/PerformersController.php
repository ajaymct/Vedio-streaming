...
class PerformersController extends MainAdminController
{
    ...
    { 
        ...
        return view('admin.pages.performer_list',compact('page_title','movies_list','language_list'));
    }
