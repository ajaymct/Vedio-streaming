...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin'], function () {
	...
	Route::get('performers', 'PerformersController@performer_list');
	Route::get('add_performers', 'PerformersController@add_performer');
	Route::get('performers/delete/{id}', 'PerformerlistController@delete');
	Route::get('performers_list', 'PerformerlistController@performer_list');
	Route::get('link', 'ExtralinkController@index');
	Route::post('extra', 'ExtralinkController@addextra');
...
Route::post('login', 'IndexController@postLogin');
Route::get('extralink', 'ExtralinkController@index');


Route::get('becomeperformer', 'PerformerController@become_performer');
Route::post('addperformer', 'PerformerController@add_performer');
...
Route::get('performer', 'PerformerController@performer');


Route::get('newlist', 'NewlistController@series');
Route::get('newseriesperson', 'NewlistController@series_person');
...
Route::get('sitemap-performer.xml', 'IndexController@sitemap_performer');
