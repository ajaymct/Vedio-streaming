        ...
        <div class="owl-carousel video-carousel" id="video-carousel">
          ...
          <div class="vfx_video_item">
            ...
            <div class="vfx_video_detail">
              <h4 class="vfx_video_title"><?php echo e(Str::limit(stripslashes($episode_data->video_title),15)); ?></h4>
             </div>
          </div>
          </a>
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Video Script Package V1.3\FOR FIRST TIME BUYER\video_script\resources\views/pages/season_episodes.blade.php ENDPATH**/ ?>