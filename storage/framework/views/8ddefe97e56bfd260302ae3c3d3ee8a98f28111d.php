                ...
                <?php endif; ?>
                 ...
                 <div class="row">
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Performers*</label>
                      <div class="col-sm-8">
                        <select name="performer[]" class="select2 select2-multiple" multiple="multiple" multiple id="movie_genre_id" data-placeholder="Select Genres...">
                                  <?php $__currentLoopData = $performers_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $performer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <option value="<?php echo e($performer->id); ?>" <?php if(isset($movie->id) && in_array($performer->id, explode(",",$movie->performer_id))): ?> selected <?php endif; ?>><?php echo e($performer->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <!-- <select class="form-control" name="performer">                               
                                <?php $__currentLoopData = $performers_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $performer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($performer->id); ?>"><?php echo e($performer->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <h4 class="m-t-0 m-b-30 header-title" style="font-size: 20px; display: none;"><?php echo e(trans('words.seo')); ?></h4>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Video Script Package V1.3\FOR FIRST TIME BUYER\video_script\resources\views/admin/pages/addeditmovie.blade.php ENDPATH**/ ?>