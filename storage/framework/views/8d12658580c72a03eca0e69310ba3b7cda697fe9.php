                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                   <?php $__currentLoopData = $video_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $video_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <td><?php echo e(stripslashes($video_data->video_title)); ?></td>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Video Script Package V1.3\FOR FIRST TIME BUYER\video_script\resources\views/admin/pages/sports_video_list.blade.php ENDPATH**/ ?>