          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card-box">
                ...
                <div class="row">
                 <div class="col-sm-6">
                      <a href="<?php echo e(URL::to('admin/season')); ?>"><h4 class="header-title m-t-0 m-b-30 text-primary pull-left" style="font-size: 20px;"><i class="fa fa-arrow-left"></i> <?php echo e(trans('words.back')); ?></h4></a>
                 </div>                  
               </div>
                ...
                <?php endif; ?>
                 ...
                 <?php echo Form::open(array('url' => array('admin/season/add_edit_season'),'class'=>'form-horizontal','name'=>'season_form','id'=>'season_form','role'=>'form','enctype' => 'multipart/form-data')); ?>  
                  ...
                  <div class="col-md-6"> 
                    <h4 class="m-t-0 m-b-30 header-title" style="font-size: 20px;"><?php echo e(trans('words.season_info')); ?></h4>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="season_name" value="<?php echo e(isset($season_info->season_name) ? stripslashes($season_info->season_name) : null); ?>" class="form-control">
                    </div>
                  </div>
                ...
                <div class="col-md-6"> 
                   <h4 class="m-t-0 m-b-30 header-title" style="font-size: 20px;"><?php echo e(trans('words.seo')); ?></h4>
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="seo_title" id="seo_title" value="<?php echo e(isset($season_info->seo_title) ? stripslashes($season_info->seo_title) : old('seo_title')); ?>" class="form-control">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.seo_desc')); ?></label>
                    <div class="col-sm-8">                       
                      <textarea name="seo_description" id="seo_description" class="form-control"><?php echo e(isset($season_info->seo_description) ? stripslashes($season_info->seo_description) : old('seo_description')); ?></textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">                      
                      <textarea name="seo_keyword" id="seo_keyword" class="form-control"><?php echo e(isset($season_info->seo_keyword) ? stripslashes($season_info->seo_keyword) : old('seo_keyword')); ?></textarea>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Video Script Package V1.3\FOR FIRST TIME BUYER\video_script\resources\views/admin/pages/addeditseason.blade.php ENDPATH**/ ?>