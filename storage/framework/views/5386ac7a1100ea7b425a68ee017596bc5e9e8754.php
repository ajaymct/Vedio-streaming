...
<div class="page-header">
  <div class="vfx_page_header_overlay">
    <div class="container">
      ...
      <li><?php echo e(trans('words.popular_in')); ?> <?php echo e($lang_info->language_name); ?></li>
      </ul>  
    </div>
    </div>
  </div>
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Video Script Package V1.3\FOR FIRST TIME BUYER\video_script\resources\views/pages/movies_by_language.blade.php ENDPATH**/ ?>