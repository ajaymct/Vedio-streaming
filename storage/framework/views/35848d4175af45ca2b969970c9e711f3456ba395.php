 ...
 <div class="main-wrap">
  <div class="section section-padding tv_show vfx_video_list_section text-white">
    <div class="container">
      ...
      <?php if(Auth::check()): ?>              
          <a class="" href="<?php echo e(URL::to('sports/name/'.$sports_video->id)); ?>">
      <?php else: ?>
         <?php if($sports_video->video_access=='Paid'): ?>
          <a class="" href="Javascript::void();" data-toggle="modal" data-target="#loginAlertModal">
         <?php else: ?>
          <a class="" href="<?php echo e(URL::to('sports/'.$sports_video->video_slug.'/'.$sports_video->id)); ?>">
         <?php endif; ?>  
      <?php endif; ?>  
      <div class="col-md-3 col-sm-4 col-xs-6">
            <div class="vfx_video_item">
              <div class="thumb-wrap"> <img src="<?php echo e(asset('upload/source/'.$sports_video->profile_image)); ?>" alt="<?php echo e($sports_video->video_title); ?>">
  ...
  -->        
              ...
              <div class="vfx_video_detail">
                <h4 class="vfx_video_title"><?php echo e(Str::limit(stripslashes($sports_video->name),20)); ?></h4>
               </div>
            </div>
      </div>
      </a>
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Video Script Package V1.3\FOR FIRST TIME BUYER\video_script\resources\views/pages/sports.blade.php ENDPATH**/ ?>