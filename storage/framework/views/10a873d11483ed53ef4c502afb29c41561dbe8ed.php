...
<table border="0" cellpadding="0" cellspacing="0" width="60%" style="margin:0 auto;border:1px solid rgba(0, 0, 0, 0.2);padding:20px;">
 <tr style="border:0">
  <td style="text-align:center">   
   <a href="<?php echo e(url('/')); ?>" target="_blank"><img src="<?php echo e(URL::asset('upload/source/'.getcong('site_logo'))); ?>" alt="" style="width: 150px;height: 150px;"></a>
  </td>
 </tr>
 <tr style="border:0">
  <td>
 ...
 <tr>
  ...
  Your Subscription on <?php echo e(getcong('site_name')); ?> has been created. You can start watching great videos on our platform..<br/>
        <br/> 
...
<?php /**PATH C:\xampp\htdocs\Video Script Package V1.3\FOR FIRST TIME BUYER\video_script\resources\views/emails/subscription_created.blade.php ENDPATH**/ ?>