            ...
            <div class="row">
              <div class="col-lg-8 col-md-8"> 
                <h2 class="banner-title">
                  ...
                  <?php if($slider_data->slider_type=="Movies"): ?>
                  <a class="" href="<?php echo e(('movies/'.App\Movies::getMoviesInfo($slider_data->slider_post_id,'video_slug').'/'.$slider_data->slider_post_id)); ?>">
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Video Script Package V1.3\FOR FIRST TIME BUYER\video_script\resources\views/pages/index.blade.php ENDPATH**/ ?>