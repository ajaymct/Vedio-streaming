<div class="left side-menu">
        ...
        <div id="sidebar-menu">
          ...
          <ul>
            ...
            <li><a href="<?php echo e(URL::to('admin/movies')); ?>" class="waves-effect <?php echo e(classActivePath('movies')); ?>"><i class="fa fa-video-camera"></i> <span> <?php echo e(trans('words.movies_text')); ?></span></a></li>
             ...
             <li><a href="<?php echo e(URL::to('admin/performers_list')); ?>" class="waves-effect <?php echo e(classActivePath('performers_list')); ?>"><i class="fa fa-users"></i> <span> Performers</span></a></li>
           <li><a href="<?php echo e(URL::to('admin/link')); ?>" class="waves-effect <?php echo e(classActivePath('link')); ?>"><i class="fa fa-users"></i> <span> 2257</span></a></li>
            <?php 
    ...
    </div><?php /**PATH C:\xampp\htdocs\Video Script Package V1.3\FOR FIRST TIME BUYER\video_script\resources\views/admin/sidebar.blade.php ENDPATH**/ ?>