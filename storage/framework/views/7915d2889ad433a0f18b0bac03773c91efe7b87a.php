    ...
    <div class="collapse navbar-collapse" id="main-nav-collapse">      
      <ul class="nav navbar-nav navbar-left">        
       ...
       <!--  <li class="dropdown"> <a href="<?php echo e(URL::to('sports')); ?>"><?php echo e(trans('words.sports_text')); ?></a>
        ...
        <li class="dropdown">
          <a href="<?php echo e(URL::to('newlist')); ?>">Performers</a>
          
        </li>
         <li class="">
          <a href="<?php echo e(URL::to('becomeperformer')); ?>">Become A Performer</a>
...
</nav><?php /**PATH C:\xampp\htdocs\Video Script Package V1.3\FOR FIRST TIME BUYER\video_script\resources\views/_particles/header.blade.php ENDPATH**/ ?>