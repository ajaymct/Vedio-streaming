 ...
 <div class="main-wrap">
  <div class="section section-padding tv_show vfx_video_list_section text-white">
    <div class="container">
      ...
      @if(Auth::check())              
          <a class="" href="{{ URL::to('sports/name/'.$sports_video->id) }}">
      @else
         @if($sports_video->video_access=='Paid')
          <a class="" href="Javascript::void();" data-toggle="modal" data-target="#loginAlertModal">
         @else
          <a class="" href="{{ URL::to('sports/'.$sports_video->video_slug.'/'.$sports_video->id) }}">
         @endif  
      @endif  
      <div class="col-md-3 col-sm-4 col-xs-6">
            <div class="vfx_video_item">
              <div class="thumb-wrap"> <img src="{{asset('upload/source/'.$sports_video->profile_image)}}" alt="{{$sports_video->video_title}}">
  ...
  -->        
              ...
              <div class="vfx_video_detail">
                <h4 class="vfx_video_title">{{Str::limit(stripslashes($sports_video->name),20)}}</h4>
               </div>
            </div>
      </div>
      </a>
