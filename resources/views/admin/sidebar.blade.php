        ...
        <div id="sidebar-menu">
          ...
          <ul>
            ...
            <li><a href="{{ URL::to('admin/movies') }}" class="waves-effect {{classActivePath('movies')}}"><i class="fa fa-video-camera"></i> <span> {{trans('words.movies_text')}}</span></a></li>
             ...
             <li><a href="{{ URL::to('admin/performers_list') }}" class="waves-effect {{classActivePath('performers_list')}}"><i class="fa fa-users"></i> <span> Performers</span></a></li>
           <li><a href="{{ URL::to('admin/link') }}" class="waves-effect {{classActivePath('link')}}"><i class="fa fa-users"></i> <span> 2257</span></a></li>
            <?php 
