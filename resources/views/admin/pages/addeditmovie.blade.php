              ...
              <div class="card-box">
                ...
                @endif
                 ...
                 <div class="row">
                    ...
                    <label class="col-sm-3 col-form-label">Performers*</label>
                      <div class="col-sm-8">
                        <select name="performer[]" class="select2 select2-multiple" multiple="multiple" multiple id="movie_genre_id" data-placeholder="Select Genres...">
                                  ...
                                  <option value="{{$performer->id}}" @if(isset($movie->id) && in_array($performer->id, explode(",",$movie->performer_id))) selected @endif>{{$performer->name}}</option>
                                @endforeach
                            </select>
                  ...
                  <h4 class="m-t-0 m-b-30 header-title" style="font-size: 20px; display: none;">{{trans('words.seo')}}</h4>
